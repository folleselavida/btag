<div id = "allReviews">
	...
	<?php if (count($coment[0])<1){
		?>
		<p>Aún no se han realizado reviews sobre éste sitio. Sé el primero!</p>
		<?php 
	...
	foreach($coment as $i => $com):?>
		<div class="coments">
			<div class="perfil noBorder">
				<img src="/images/tags/<?php echo $com["calificacion"]?>s.png" alt=" Calificación a <?php echo $com["calificacion"]?>" class="tag2" />
			...
			<div class="text_review2">
				...
				<div class="footer_coment">
					...
					<a href="javascript: showDueno(<?php echo ($i +1) ?>) " class="link_dueno">comentario del dueño [+]</a>
